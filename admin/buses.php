  ...
  <div class="modal fade" id="myModal'. $myrow['busno'].'" role="dialog">
    <div class="modal-dialog">  <!-- Modal content-->
      ...
      <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Edit - '.$myrow['bus'].'</h4>
        </div>
...
<iframe src="edit.php?id='. $myrow['busno'].'" frameborder="0" height="600" width="400px" style="margin-top: -20px;"></iframe>
      ...
      <!-- End Of Modal-->
    <a href="" data-toggle="modal" data-target="#myModal1'. $myrow['busno'].'">Full Details</a>
 <!-- Modal -->
  <div class="modal fade" id="myModal1'. $myrow['busno'].'" role="dialog">
    <div class="modal-dialog">  <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <div class="modal-body">
<iframe src="details.php?id='. $myrow['busno'].'" frameborder="0" height="600" width="400px" style="margin-top: -20px;"></iframe>
        </div>
      </div>
      <!-- End Of Modal content-->
          </div>
  </div>
      <!-- End Of Modal-->  <a href="delete.php?id='.$myrow['busno'].'">Delete</a> </td>';
     echo '</tr></tbody>';
