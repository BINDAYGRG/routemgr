...
<input class="form-control input-lg" type="text" name="name" name="name" placeholder="Enter Your Name"required="true"><br/>
<label>Address</label>
<input class="form-control input-lg" type="text" name="address" placeholder="Enter your Address" required="true"/><br>
<label>Contact</label>
<input class="form-control input-lg" type="tel" name="contact"  placeholder="Enter Your Contact No." required="true"/><br>
