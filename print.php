...
while($rows = mysql_fetch_array($results))
    ...
    echo '<b>Number of Seats :</b>'. $rows['seat_reserve'].'<br>';
		echo '<b>Seat Numbers: </b>'.$seatnum.'<br>';
    echo '<b>Confirmation Code: </b>'.$id.' (Confirmation Code is need to verify the booking - Keep this confirmation code safe with you before and while travelling.)<br>';
	}
?>
</div>
